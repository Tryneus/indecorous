...
namespace Catch {
    ...
    public:
        ...
        Tag( const std::string& name, bool _isNegated )
        :   m_name( name ),
...
namespace Catch {
    ...
    public:
        ...
        void useStream( const std::string& streamName ) {
            Stream _stream = createStream( streamName );
            setStreamBuf( _stream.streamBuf );
            m_stream.release();
            m_stream = _stream;
        }
...
namespace Catch {
    ...
    public:
        ...
        explicit Command( const std::string& _name ) : m_name( _name ) {
        }
...
namespace Catch {
    ...
    inline void MakeList( const ConfigData& config ) {
...
namespace Catch {
    ...
    public:
        ...
        explicit Runner( const Config& _config, const Ptr<IReporter>& reporter )
