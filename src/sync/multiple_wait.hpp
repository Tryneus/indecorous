...
private:
    ...
    public:
        multiple_wait_callback_t(multiple_wait_t* multiple_waiter,
                                 wait_object_t* target) :
    ...
    public:
        bool operator () (const multiple_wait_callback_t* left,
                          const multiple_wait_callback_t* right) {
